...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/payrun/apis.md
...
- name: Pay Run.IO - Gets the error model template
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/payrun/templateserrormodel-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/payrun/templateserrormodel-get-openapi.md
- name: Pay Run.IO - Gets the error model template
  x-api-slug: templateserrormodel-get
  description: Return the error model data object template
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28484-payrun-io.jpg
