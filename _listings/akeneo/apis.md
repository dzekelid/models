...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/akeneo/apis.md
specificationVersion: "0.14"
apis:
- name: Official Akeneo PIM API - product models (2.x only)
  x-api-slug: restv1productmodels-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/akeneo/restv1productmodels-get-openapi.md
- name: Official Akeneo PIM API - product models (2.x only)
  x-api-slug: restv1productmodels-patch
  description: Product models (2.x only).
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/akeneo-logo.png
  humanURL: https://akeneo.com
  baseURL: https://example.com//api
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/akeneo/restv1productmodels-patch-openapi.md
- name: Official Akeneo PIM API - product model (2.x only)
  x-api-slug: restv1productmodelsamor-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/akeneo/restv1productmodelsamor-get-openapi.md
- name: Official Akeneo PIM API - product model (2.x only)
  x-api-slug: restv1productmodelsamor-patch
  description: Assuming that the given code is the code of an existing product model
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/akeneo-logo.png
  humanURL: https://akeneo.com
  baseURL: https://example.com//api
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/akeneo/restv1productmodelsamor-patch-openapi.md
- name: Official Akeneo PIM API - product model (2.x only)
  x-api-slug: restv1productmodels-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/models/master/_listings/akeneo/restv1productmodels-post-openapi.md
- name: Official Akeneo PIM API - product model (2.x only)
  x-api-slug: restv1productmodels-post
  description: Product model (2.x only).
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/akeneo-logo.png
